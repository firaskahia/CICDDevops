...
class TestOperateurServiceMock {
	...
	Operateur o = Operateur.builder().idOperateur((long) 7).nom("Med").prenom("Med").password("azerty").build();

	@Test
	public void AddOperateur() {
		Operateur o_add = new Operateur();
		o_add.setNom("Med add");
		o_add.setPrenom("Med add");
...
*/
	...
	public void EditOperateur_ifFound() {
		...
		o_edit.setNom("Med edit");

		Operateur new_o_edit = new Operateur();
		new_o_edit.setNom("new Med edit");
